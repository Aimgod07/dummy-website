...
const HotelEntryForm = () => {
  ...
  const submitPassengers = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('http://localhost:3000/api/v1/hotel/add', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Hotel Entry Form</h1>
      <form onSubmit={submitPassengers}>
